        ...
        <div className="flex justify-between h-20">
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0 flex items-center">
              <span className="text-2xl font-serif font-bold text-gold tracking-wider">THE RAMESHWARAM</span>
            </Link>
          </div>
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              href="/contact"
              className="bg-gold text-white px-6 py-2 rounded-full hover:bg-gold/90 transition-colors duration-200"
            >
              Get a Quote
            </Link>
          </div>
        ...
        <div className="md:hidden bg-cream border-b border-gold/20">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link
              href="/contact"
              onClick={() => setIsOpen(false)}
              className="block px-3 py-2 bg-gold text-white rounded-md text-center"
            >
              Get a Quote
            </Link>
          </div>
